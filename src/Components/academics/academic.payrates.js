            ...
            <div className="m-5">
                <div className="row">
                    <div className="col-sm-12">
                        <h3 className="text-muted text-center">Academic Payrates</h3> <hr />
                    </div>
                        ...
                        <p className="text-justify font-weight-light">
                            <div class="card m-3" >
                                <div className="card-body">
                                    <h5 className="card-title">Card payrate 1</h5>
                                    <h6 className="card-subtitle mb-2 text-muted">Card subtitle payrate 1</h6>
                            ...
                            <div class="card m-3" >
                                <div className="card-body">
                                    <h5 className="card-title">Card payrate 2</h5>
